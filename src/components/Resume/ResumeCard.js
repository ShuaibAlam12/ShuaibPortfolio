    ...
    return (
        <div className='w-full h-1/3 group flex'>
            <div className='w-10 h-[6px] bgOpacity mt-16 relative'>
                <span className='absolute w-5 h-5 rounded-full -top-2 -left-3 flex justify-center first-letter:items-center bg-black bg-opacity-60'>
            ...
            <div className='w-full bg-black bg-opacity-20 hover:bg-opacity-30 duration-300 
                ...
                <div className='flex flex-col lgl:flex-row justify-between gap-4 lgl:gap-0 lgl:items-center'>
                    <div>
                        <h3 className=' text-xl md:text-2xl font-smibold group-hover:text-white duration-300'>{title}</h3>
